...
const SampleEmailQuestions = {
  first: `Hello, I was wondering where I could go to find out more about Joyce's devotionals and other works?
    -Kevin J`
};

export {SampleEmailQuestions};
